...
// Encrypts one bit of the message
...
/*
Inputs:
M -> Curve point M(m,y) mapped from message m
k -> Random scalar value k from interval (1,p), where p=21888242871839275222246405745257275088548364400416034343698204186575808495617
// @audit might be worth asserting that k is > 1 and < p-1?
*/
...
template ElGamalEncryptPoint() {
    ...
    // Random scalar value k from interval (1,p), 
