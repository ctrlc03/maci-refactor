import { AccQueue, hash5 } from "maci-crypto"
import { Keypair, PublicKey, StateLeaf, blankStateLeaf, blankStateLeafHash } from "maci-domainobjs"
...
export class MaciState {
    ...
    // @note check this cause in Poll we assert it's undefined as some point
