...
declare module 'circomlibjs' {
    export class SMT {
        ...
        _splitBits(_key: any): any[];
        update(_key: any, _newValue: any): Promise<any>;
        delete(_key: any): Promise<any>;
        insert(_key: any, _value: any): Promise<any>;
        find(_key: any): Promise<any>;
        _find(key: any, keyBits: any, root: any, level: number): Promise<any>;
    }
